...
from sensor.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact,ModelEvaluationArtifact,ModelPusherArtifact,ModelPusherArtifact,ModelPusherArtifact
...
class TrainingPipeline:
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            model_trianer = ModelTrainer(model_trainer_config=model_trainer_config,
                                        data_transformation_artifact=data_transformation_artifact)
            model_trainer_artifact = model_trianer.initiate_model_trainer()
